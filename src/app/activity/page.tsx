...
export default function GuildActivity() {
  // Mock data for guild activity
  const recentActivity = [
    {
      id: 1,
      player: "BloodKnight",
      action: "Achieved Gladiator Title",
      timestamp: "2 hours ago",
      icon: Trophy,
      color: "text-blood-gold"
    },
    {
      id: 2,
      player: "ShadowReaper",
      action: "Won 3v3 Arena Match",
      timestamp: "4 hours ago",
      icon: Sword,
      color: "text-blood-glow"
    },
    {
      id: 3,
      player: "DarkMage",
      action: "Completed Mythic+15",
      timestamp: "6 hours ago",
      icon: Target,
      color: "text-blood-purple"
    },
    {
      id: 4,
      player: "BloodPriest",
      action: "Reached 2400 Rating",
    ...
    },
    {
      id: 6,
      player: "BloodWarrior",
      action: "Completed Raid Achievement",

    ...
    <div className="relative py-12 bg-cover bg-center bg-no-repeat" style={{
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex justify-center">
          <a href="https://discord.gg/9hgAHRfD9x" target="_blank" className="bg-[#5865F2] hover:bg-[#4752C4] text-white px-8 py-3 font-medium rounded-md transition-colors duration-200 shadow-lg hover:shadow-xl flex items-center justify-center">
            <Image
